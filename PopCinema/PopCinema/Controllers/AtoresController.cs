...
namespace PopCinema.Controllers
{
    public class AtoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nome,Biografia,Sexo,Nacionalidade,DataNascimento,FotoAtor")] Atores atores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nome,Biografia,Sexo,Nacionalidade,DataNascimento,FotoAtor")] Atores atores)
        {
            if (ModelState.IsValid)
            {
