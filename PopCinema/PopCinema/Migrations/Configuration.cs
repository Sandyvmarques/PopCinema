        ...
        protected override void Seed(PopCinema.Models.ApplicationDbContext context)
        {
            ...
            filmes.ForEach(aa => context.Filmes.AddOrUpdate(a => a.ID, aa));
               ...
               new Utilizadores {ID=4, Nome="Lurdes Vieira",   Username="  LurdesVieira123",   DataNascimento="30/06/1998" ,    Email="  LurdesVieira@hotmail.com",  Foto="  LurdesVieira.jpg"},
                ...
                new Atores {ID=0,  Nome="Chris Evans",
                            ...
                            DataNascimento="21/12/1948",FotoAtor ="ChrisEvans.jpg"},
                new Atores {ID=1,  Nome="Chris Hemsworth",
                            ...
                            Sexo="Masculino",   Nacionalidade="Washington, D.C., U.S.",
                            DataNascimento ="21/12/1948",FotoAtor ="ChrisHemsworth.jpg"},
                new Atores {ID=2,  Nome="Samuel L. Jackson",
                            ...
                            Sexo="Masculino",   Nacionalidade="Washington, D.C., U.S.",
                            DataNascimento="21/12/1948", FotoAtor ="SamuelLJackson.jpg"},
                new Atores {ID=3,  Nome="Brie Larson",
                            ...
                            Sexo="Masculino",   Nacionalidade="Washington, D.C., U.S.",
                            DataNascimento="21/12/1948",FotoAtor ="BrieLarson.jpg"},
                new Atores {ID=4,  Nome="James McAvoy",
                ...
                new Atores {ID=5,  Nome="Bruce Willis ",
                ...
                new Atores {ID=6,  Nome="Zachary Levi",
                            ...
                            DataNascimento ="29/09/1980",FotoAtor ="ZacharyLevi.jpg"},
                new Atores {ID=7,  Nome="Asher Angel",
                            ...
                            DataNascimento ="29/09/1980",FotoAtor ="AsherAngel.jpg"},
                new Atores {ID=8,  Nome="Ron Perlman",
                            ...
                            DataNascimento ="13/04/1950",FotoAtor="RonPerlman.jpg"},
                new Atores {ID=9, Nome="Selma Blair",
                            ...
                            DataNascimento ="23/06/1972",FotoAtor="SelmaBlair.jpg"},
                new Atores {ID=10, Nome="Jason Momoa",
                            ...
                            DataNascimento ="28863",     FotoAtor="JasonMomoa.jpg"},
                new Atores {ID=11, Nome="Amber Heard",
                            ...
                            Sexo="Masculino",Nacionalidade="Washington, D.C., U.S.",
                            DataNascimento ="21/12/1948",FotoAtor="AmberHeard.jpg"},
                new Atores {ID=12, Nome="Taylor Russell",
                            ...
                            DataNascimento ="18/07/1994",FotoAtor="TaylorRussell.jpg"},
                new Atores {ID=13, Nome="Logan Miller",
                            Biografia ="Logan Miller (born c. 1992) is an American actor.",
                            Sexo="Feminino",Nacionalidade="Vancouver, British Columbia, Canada",
                            DataNascimento ="18/07/1994",FotoAtor="LoganMiller.jpg"},
                new Atores {ID=14, Nome="Chloë Grace Moretz",
                            ...
                            DataNascimento ="36134",     FotoAtor="ChloëMoretz.jpg"},
                new Atores {ID=15, Nome="Isabelle Huppert ",
                            ...
                            DataNascimento ="23/06/1940",FotoAtor="IsabelleHuppert.jpg"},
                new Atores {ID=16, Nome="Anne Hathaway",
                            ...
                            Sexo="Feminino",Nacionalidade="Paris, France",
                            DataNascimento ="23/06/1979",FotoAtor="AnneHathaway.jpg"},
                new Atores {ID=17, Nome="Rebel Wilson.",
                            ...
                            Sexo="Feminino",Nacionalidade="Paris, France",
                            DataNascimento ="23/06/1980",FotoAtor="RebelWilson.jpg"},
                new Atores {ID=18, Nome="Olivia Colman",
                            ...
                            Sexo="Feminino",Nacionalidade="Paris, France",
                            DataNascimento ="23/06/1981",FotoAtor="OliviaColman.jpg"},
                new Atores {ID=19, Nome="Emma Stone",
                ...
                var filmesAtores = new List<FilmesAtores>
                   {
               new FilmesAtores {AtoresFK=0, FilmesFK=0, Personagem="Captain America"},
               new FilmesAtores {AtoresFK=1, FilmesFK=0, Personagem="Thor"},
               new FilmesAtores {AtoresFK=2, FilmesFK=0, Personagem="Nick Furry"},
               new FilmesAtores {AtoresFK=3, FilmesFK=1, Personagem="Captain Marvel"},
                 };
